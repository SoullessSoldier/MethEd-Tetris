...
export class View {
    ...
    preview(){
        // const pressEnterBlock = document.createElement('div');
        // pressEnterBlock.classList.add('press-enter');
        // pressEnterBlock.textContent = 'Press Enter';
        // this.container.append(pressEnterBlock);
    ...
    createBlockScore(){
        ...
        // scoreBlock.style.gridArea = 'score';
    ...
    createBlockNextTetramino(){
        const scoreNextTetraminoBlock = document.createElement('div');
        //scoreNextTetraminoBlock.style.gridArea = 'next';
        scoreNextTetraminoBlock.style.cssText = `
        ...
        scoreNextTetraminoBlock.append(canvas);

        this.container.append(scoreNextTetraminoBlock);
